...
public class i_apple_wantnt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_apple_wantnt);

        play_image = findViewById(R.id.imageView5);

        i_apple_wantnt_sound = MediaPlayer.create(this,R.raw.i_apple_wantnt);
