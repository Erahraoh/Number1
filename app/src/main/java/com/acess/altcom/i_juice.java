...
public class i_juice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_juice);
    ...
    public void juicenext1(View v){
        Intent intent = new Intent(this, i_juice_want.class);
        startActivity(intent);
    }
    public void juicenext2(View v){
        Intent intent = new Intent(this, i_juice_wantnt.class);
        startActivity(intent);
    }
