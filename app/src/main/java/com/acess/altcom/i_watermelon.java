...
public class i_watermelon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_watermelon);
    ...
    public void watermelonnext1(View v){
        Intent intent = new Intent(this, i_watermelon_want.class);
        startActivity(intent);
    }
    public void watermelonnext2(View v){
        Intent intent = new Intent(this, i_watermelon_wantnt.class);
        startActivity(intent);
    }
