...
public class i_meat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_meat);
    ...
    public void meatnext1(View v){
        Intent intent = new Intent(this, i_meat_want.class);
        startActivity(intent);
    }
    public void meatnext2(View v){
        Intent intent = new Intent(this, i_meat_wantnt.class);
        startActivity(intent);
    }
