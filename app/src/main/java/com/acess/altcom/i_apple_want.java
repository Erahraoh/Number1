...
public class i_apple_want extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_apple_want);

        play_image = findViewById(R.id.imageView5);

        i_kiwi_want_sound = MediaPlayer.create(this,R.raw.i_apple_want);
