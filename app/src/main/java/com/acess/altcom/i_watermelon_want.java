...
public class i_watermelon_want extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i_watermelon_want);

        play_image = findViewById(R.id.imageView5);

        i_kiwi_want_sound = MediaPlayer.create(this,R.raw.i_watermelon_want);
